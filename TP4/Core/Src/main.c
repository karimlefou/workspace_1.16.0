...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  float a=get_speed();
	  snprintf(buffer1,16,"Speed : %d \n\r",speed);
	  snprintf(buffer2,16,"Speed en tour par seconde : %d",a);
	  ssd1315_Draw_String(0,0,buffer1,&Font_11x18);
	  ssd1315_Draw_String(0, 18, buffer2, &Font_11x18);
	  ssd1315_Refresh();
